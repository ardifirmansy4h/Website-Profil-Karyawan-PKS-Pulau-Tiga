...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800 text-center">Tambah Data Karyawan PKS-Pulau Tiga</h1>
                    ...
                    <form action="/post" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="bagian" class="form-control" id="bagian"
                                value="{{ Session::get('bagian') }}" placeholder="Masukkan Bagian Bekerja">
                        </div>
                        <div class="mb-3">
                            <label for="gol" class="form-label">Golongan</label>
                            <input type="text" name="gol" class="form-control" id="ct"
                                value="{{ Session::get('gol') }}" placeholder="Masukkan Golongan">
                        </div>
                        <div class="mb-3">
                            <label for="agama" class="form-label">Agama</label>
                            <input type="text" name="agama" class="form-control" id="agama"
                                value="{{ Session::get('agama') }}" placeholder="Masukkan Agama">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="tgl_pensiun" class="form-control" id="tgl_pensiun"
                                placeholder="Masukkan Tanggal Pensiun">
                        </div>
                        <div class="mb-3">
                            <label for="pendidikan" class="form-label">Pendidikan Terakhir</label>
                            <input type="text" name="pendidikan" class="form-control" id="pendidikan"
                                value="{{ Session::get('pendidikan') }}" placeholder="Masukkan Pendidikan Terakhir">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jml_anak" class="form-control" id="jml_anak"
                                placeholder="Masukkan Jumlah Tanggungan">
                        </div>
                        <div class="mb-3">
                            <label for="ct" class="form-label">Sisa Cuti Tahunan</label>
                            <input type="text" name="cuti_tahunan" class="form-control" id="cuti_tahunan"
                                placeholder="Masukkan Sisa Cuti Tahunan">
                        </div>
                        <div class="mb-3">
                            <label for="cp" class="form-label">Sisa Cuti Panjang</label>
                            <input type="text" name="cuti_panjang" class="form-control" id="cuti_panjang"
                                placeholder="Masukkan Sisa Cuti Panjang">
                        </div>
                        <div class="mb-3">
